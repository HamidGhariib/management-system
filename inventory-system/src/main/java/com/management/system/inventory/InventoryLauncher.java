package com.management.system.inventory;

import com.management.system.inventory.messagingrabbitmq.Receiver;
...
public class InventoryLauncher {
    ...
    public static void main(String[] args) {
        SpringApplication.run(InventoryLauncher.class, args);
    }
